...
description: Fast stock valuation calculator - compute PEG, EV/EBITDA, Rule of 40, DCF and more with simple commands. Inspired by YouTube tutorial (https://youtu.be/gVWvhIAtGDE) and Day1Global Tech Earnings Deepdive Skill.
---
...
| `value dcf <ticker> --wacc=0.10 --growth=0.15 --terminal=0.03` | Custom DCF |
...
|-----------|-------------|---------|
| `--wacc=N` | Weighted Average Cost of Capital (discount rate) | 10% (0.10) |
| `--growth=N` | Future revenue/earnings growth rate | 5% (0.05) |
` | Terminal growth| `--terminal=N rate | 2.5% (0.025) |
...
**Inspired by:**
- YouTube: https://youtu.be/gVWvhIAtGDE (布萊恩穩賺 - Stock valuation screening method)
